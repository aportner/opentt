...
WebServer.prototype.init = function()
{
    ...
    this.app.use( '/assets/images/floater', express.static( this.config.paths.imageAssets ) );
    ...
    this.app.use( '/images/tour', express.static( this.www + this.config.paths.roomManagerAssets + '/images/tour' ) );
    ...
    this.app.use( '/assets/web/sounds', express.static( this.www + this.config.paths.sounds ) );
    this.app.get( '/images/playlist/queue-icons.png', this.handleQueueIcons.bind( this ) );
    this.app.get( '/images/playlist/empty-record.png', this.handleEmptyRecord.bind( this ) );
    this.app.get( '/images/sprites/playlist-sprite.png', this.handlePlaylistSprite.bind( this ) );
    this.app.get( '/images/sprites/chat-settings-sprite@2x.png', function( req, res ) { res.sendFile( _this.www + _this.config.paths.roomManagerAssets + "/images/sprites/chat-settings-sprite@2x.png" ); } );
...
WebServer.prototype.handleQueueIcons = function( req, res )
{
    res.sendFile( this.www + this.config.paths.roomManagerAssets + "/images/playlist/queue-icons.png" );
}


WebServer.prototype.handleEmptyRecord = function( req, res )
{
    res.sendFile( this.www + this.config.paths.roomManagerAssets + "/images/playlist/empty-record.png" );
}


WebServer.prototype.handlePlaylistSprite = function( req, res )
{
    res.sendFile( this.www + this.config.paths.roomManagerAssets + "/images/sprites/playlist-sprite.png" );
}
